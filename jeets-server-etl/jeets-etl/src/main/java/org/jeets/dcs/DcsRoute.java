...
public class DcsRoute extends RouteBuilder { // plain Camel without Swing!
  ...
  public void configure() throws Exception {
    //		EL #{{ raises EL syntax error: Expecting expression, but creates %23 and works. Fix some
    // time.
        ...
        .process(
            new Processor() {
              ...
              public void process(Exchange exchange) throws Exception {
                ...
                //              LOG.info("AckResponder.process getIn jpa.Device.uniqueid " +
                // devEntity.getUniqueid());
                //              LOG.info("DcsProcessor received Device: {} at {}",
                // devProto.getUniqueid(), new Date().getTime());
