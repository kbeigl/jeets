...
/**
 * Initialize Channel to serve a Jeets.Device Protobuffer Message to the NettyConsumer endpoint.
 *
 * <p>This class is optional for the ETL and can be used to replace the Extractor inside the DCS by
 * registering it ...
 *
