 ...
 * Repository build with *Java-11*-OpenJDK-11.0.8-1 under Windows 10 :
 
[source,text]
-----------------
> mvn <goals> -X
	Apache Maven 3.6.0 (97c98ec64a1fdfee7767ce5ffb20918da4f719f3; 2018-10-24T20:41:47+02:00)
	Maven home: C:\prox\Maven\apache-maven-3.6.0\bin\..
...
Note that most projects are still running with compiler settings 1.8
which will be removed as we move on.
