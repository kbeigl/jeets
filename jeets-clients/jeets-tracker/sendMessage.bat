...
java -jar target\jeets-tracker-0.1-jar-with-dependencies.jar localhost 5001 "imei:359587010124999,help me,1201011201,,F,120100.000,A,4903.0000,N,1210.0000,E,0.00,;"