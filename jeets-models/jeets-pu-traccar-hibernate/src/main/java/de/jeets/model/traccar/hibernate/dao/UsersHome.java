...
import org.jeets.model.traccar.hibernate.Users;

import static org.hibernate.criterion.Example.create;

/**
 * Home object for domain model class Users.
 * @see org.jeets.model.traccar.hibernate.Users
...
public class UsersHome {
	...
	public Users findById(int id) {
		...
		try {
			Users instance = (Users) sessionFactory.getCurrentSession().get("de.jeets.model.traccar.hibernate.Users",
					id);
			if (instance == null) {
	...
	public List<Users> findByExample(Users instance) {
		...
		try {
			List<Users> results = (List<Users>) sessionFactory.getCurrentSession()
					.createCriteria("de.jeets.model.traccar.hibernate.Users").add(create(instance)).list();
