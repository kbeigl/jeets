...
public class GeometryColumnsId implements java.io.Serializable {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof GeometryColumnsId)) return false;
    ...
    return ((this.getFTableCatalog() == castOther.getFTableCatalog())
        ...
        && ((this.getFGeometryColumn() == castOther.getFGeometryColumn())
            || (this.getFGeometryColumn() != null
                && castOther.getFGeometryColumn() != null
  ...
  public int hashCode() {
    ...
    result =
        37 * result + (getFGeometryColumn() == null ? 0 : this.getFGeometryColumn().hashCode());
