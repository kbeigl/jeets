...
public class Statistic implements Serializable {
	...
	public String toString() {
		return "Statistic [id=" + id + ", activedevices=" + activedevices + ", activeusers=" + activeusers
				+ ", attributes=" + attributes + ", capturetime=" + capturetime + ", geocoderrequests="
				+ geocoderrequests + ", geolocationrequests=" + geolocationrequests + ", mailsent=" + mailsent
				+ ", messagesreceived=" + messagesreceived + ", messagesstored=" + messagesstored + ", requests="
				+ requests + ", smssent=" + smssent + "]";
	}
