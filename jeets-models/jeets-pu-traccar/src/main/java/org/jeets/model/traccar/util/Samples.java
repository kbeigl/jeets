...
/**
 * These samples demonstrate how to create Entities and relate them to each other.
 *
...
public class Samples {
   ...
   * A Device can have many Positions and many Events. In this method each Position is modeled with
   * 1:n Events.
   *
   * <p>It's a fundamental design decision for higher level modules, if a single Position should
   * hold more than one Event or not. <br>
   ...
   *
   * <p>A Device can have many Positions and many Events. In this method each Position is modeled
   * with one Event and vice versa, practically a 1:1 relation. <br>
   ...
   *
   * <p>Note that the ORM relation is set in both directions with device.setPositions and
   * position.setDevice!
   */
  ...
  /**
   * return Device Entity with {@link #uniqueId} named {@link #sampleDeviceName} with last update
  ...
  /**
   * Create unrelated Position with latitude, longitude and fixtime 'now' (time of creation) and
  ...
  public static List<Position> createU1Track() {
    ...
    positions.add(
        createTrackPoint("04.11.17 00:37:29", 53.56985d, 10.057684d, "Wandsbeker Chaussee"));
    ...
    positions.add(
        createTrackPoint("04.11.17 00:51:29", 53.558853d, 9.989303d, "Stephansplatz (Oper/CCH)"));
    ...
    positions.add(
        createTrackPoint("04.11.17 00:58:29", 53.588735d, 9.990741d, "Kellinghusenstraße"));
    return positions;
  }
