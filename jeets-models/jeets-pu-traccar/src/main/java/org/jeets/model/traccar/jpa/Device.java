...
@NamedQuery(
    name = "findDeviceByUniqueId",
    query = "SELECT d FROM Device d WHERE d.uniqueid = :uniqueid")
public class Device implements Serializable {
  ...
  @SequenceGenerator(
      name = "tc_devices_id_gen",
      sequenceName = "tc_devices_id_seq",
      allocationSize = 1)
   ...
   *
   * <p>Identical timestamps could be disambiguated with IDs to determine exact submission order,
   * but should not be implemented for a production system.
   */
