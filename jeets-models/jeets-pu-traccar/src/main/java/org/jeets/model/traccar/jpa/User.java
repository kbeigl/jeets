...
public class User implements Serializable {
  ...
  public String toString() {
    ...
    return "User [id="
        ...
        + ", calendars="
        + (calendars != null ? calendars.subList(0, Math.min(calendars.size(), maxLen)) : null)
        + ", commands="
        + (commands != null ? commands.subList(0, Math.min(commands.size(), maxLen)) : null)
        + ", devices="
        + (devices != null ? devices.subList(0, Math.min(devices.size(), maxLen)) : null)
        + ", drivers="
        + (drivers != null ? drivers.subList(0, Math.min(drivers.size(), maxLen)) : null)
        + ", geofences="
        ...
        + ", maintenances="
        + (maintenances != null
            ? maintenances.subList(0, Math.min(maintenances.size(), maxLen))
            : null)
        + ", notifications="
        + (notifications != null
            ...
            : null)
        + ", users1="
        + (users1 != null ? users1.subList(0, Math.min(users1.size(), maxLen)) : null)
        + ", users2="
        + (users2 != null ? users2.subList(0, Math.min(users2.size(), maxLen)) : null)
        + "]";
  }
}
