...
public class Maintenance implements Serializable {
	...
	public String toString() {
		final int maxLen = 3;
		return "Maintenance [id=" + id + ", attributes=" + attributes + ", name=" + name + ", period=" + period
				+ ", start=" + start + ", type=" + type + ", devices="
