...
import org.jeets.model.schema.Utils;

/**
 * This class can be used to export data from the **production DB** to test
 * directories for testing. The export is not part of the regular test cycle and
 * should be handled with care. Plain Database access without JPA.
 */
...
//		dbunit.sourceforge.net/faq.html#extract
		...
		System.out.println("pu.traccar.jdbc.password: " + props.getProperty("pu.traccar.jdbc.password"));
		...
		Connection jdbcConnection = DriverManager.getConnection(props.getProperty("pu.traccar.jdbc.url"),
				props.getProperty("pu.traccar.jdbc.user"), props.getProperty("pu.traccar.jdbc.password"));
