...
/**
 * General purpose Route to send different inputs (from) to a single output of any DCS. i.e. System
 * Endpoint to receive GPS messages in one format.
 *
 * <p>Every jeets-protocol should be tested against this RouteBuilder as a prerequisite for any
 * subsequent DCS Manager.
 */
