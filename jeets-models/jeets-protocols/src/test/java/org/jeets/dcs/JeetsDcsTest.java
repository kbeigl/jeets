...
public class JeetsDcsTest extends CamelTestSupport {
  ...
  public void testJeetsDcsRoute() throws Exception {
    ...
    //      start test
    Jeets.Acknowledge response =
        (Jeets.Acknowledge)
            template.requestBody(
                "netty:tcp://localhost:5200" + "?clientInitializerFactory=#ack&sync=true",
  ...
  protected RouteBuilder createRouteBuilder() throws Exception {
    ...
    String from = "netty:tcp://localhost:5200" + "?serverInitializerFactory=#jeets&sync=true";
